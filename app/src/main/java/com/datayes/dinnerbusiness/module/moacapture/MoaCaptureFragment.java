...
public class MoaCaptureFragment extends Fragment implements SurfaceHolder.Callback {

    private MoaCaptureActivityHandler handler;
...
//        playBeepSoundAndVibrate();
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new MoaCaptureActivityHandler(this, decodeFormats, characterSet, viewfinderView);
        }
    }
