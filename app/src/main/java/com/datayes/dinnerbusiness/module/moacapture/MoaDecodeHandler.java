...
public class MoaDecodeHandler extends Handler {

    private static final String TAG = MoaDecodeHandler.class.getSimpleName();

    private final MoaCaptureFragment fragment;
    private final MultiFormatReader multiFormatReader;

    MoaDecodeHandler(MoaCaptureFragment fragment, Hashtable<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            bundle.putParcelable(MoaDecodeTread.BARCODE_BITMAP, source.renderCroppedGreyscaleBitmap());
